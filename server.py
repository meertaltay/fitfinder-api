...
<div class="top-header">
  <img id="hdr-logo" src="" style="width:30px;height:30px;border-radius:8px">
  <span class="brand-text">fitchy.</span>
</div>
<div class="app">
  <div id="home" style="padding:0 20px">
    <div style="padding-top:68px;padding-bottom:30px">
      <div style="display:flex;justify-content:center;margin-bottom:16px">
        <img src="data:image/png;base64," style="width:80px;height:80px;border-radius:18px;box-shadow:0 0 25px rgba(255,32,121,.4);object-fit:cover">
...
applyLang();
// Copy hero logo to header
(function(){var heroImg=document.querySelector('#home img[src^="data:image"]');if(heroImg)document.getElementById('hdr-logo').src=heroImg.src})();
