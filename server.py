...
<div class="app">
  ...
  <div class="bnav">
    ...
    <div class="bnav-item bnav-logo" id="nav-logo" onclick="navTo('home')"><div class="bnav-logo-ring"><span><img src="data:image/png;base64," style="width:36px;height:36px;border-radius:10px;object-fit:cover"></span></div></div>
